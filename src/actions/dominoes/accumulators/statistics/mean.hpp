...
namespace impl
{
        ...
        mergable_base
    {
        ...
        void operator+=(immediate_mean_impl const &other)
        {
            // TODO do this
        }
...
namespace tag
{
    ...
    {
        static const std::string& name() {
            static std::string name("immediate_mean");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("mean_of_weights");
            return name;
        }
    ...
    {
        static const std::string& name() {
            static std::string name("immediate_mean_of_weights");
            return name;
        }
        typedef mpl::true_ is_weight_accumulator;
        /// INTERNAL ONLY
    ...
    {
        static const std::string& name() {
            static std::string name("mean_of_variates");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("immediate_mean_of_variates");
            return name;
        }
        /// INTERNAL ONLY
        ///
