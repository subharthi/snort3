...
namespace tag
{
      ...
      : depends_on<peaks_over_threshold<LeftRight> >
    {
        static const std::string& name() {
            static std::string name("pot_quantile");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("pot_quantile_prob");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("weighted_pot_quantile");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("weighted_pot_quantile_prob");
            return name;
        }
        /// INTERNAL ONLY
        ///
