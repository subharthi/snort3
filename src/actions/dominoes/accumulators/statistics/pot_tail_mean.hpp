...
#include "statistics/peaks_over_threshold.hpp"
#include "statistics/weighted_peaks_over_threshold.hpp"
#include "statistics/pot_quantile.hpp"
#include "statistics/tail_mean.hpp"
...
namespace tag
{
      ...
      : depends_on<peaks_over_threshold<LeftRight>, pot_quantile<LeftRight> >
    {
        static const std::string& name() {
            static std::string name("pot_tail_mean");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("pot_tail_mean_prob");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("weighted_pot_tail_mean");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("weighted_pot_tail_mean_prob");
            return name;
        }
        /// INTERNAL ONLY
        ///
