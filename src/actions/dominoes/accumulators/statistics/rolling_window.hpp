...
namespace impl
{
        ...
        mergable_base
    {
        ...
        void operator+=(rolling_window_plus1_impl const &other)
        {
            for( auto const &i : other.buffer_ ) {
                this->buffer_.push_back(i);
            }
        ...
        void serialize(Archive & ar, const unsigned int version) {
            // TODO serialize the circular buffer
            //ar & BOOST_SERIALIZATION_NVP(buffer_);
        }
...
namespace tag
{
      ...
      , tag::rolling_window_size
    {
        static const std::string& name() {
            static std::string name("rolling_window_plus1");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("rolling_window");
            return name;
        }
        /// INTERNAL ONLY
        ///
