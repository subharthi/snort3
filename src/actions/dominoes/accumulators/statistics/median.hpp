...
#include "statistics/p_square_cumul_dist.hpp"
...
namespace tag
{
    ...
    {
        static const std::string& name() {
            static std::string name("with_density_median");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("with_p_square_cumulative_distribution_median");
            return name;
        }
        /// INTERNAL ONLY
        ///
