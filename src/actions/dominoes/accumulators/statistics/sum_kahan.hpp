...
#include "statistics/weighted_sum_kahan.hpp"
    ...
    mergable_base
{
    ...
    */
    ...
    void operator+=(sum_kahan_impl const &other)
    {
        //TODO do this
    }
    ...
    void serialize(Archive & ar, const unsigned int version) {
        ...
        ar & BOOST_SERIALIZATION_NVP(compensation);
    }
...
namespace tag
{
      ...
      : depends_on<>
    {
        static const std::string& name() {
            static std::string name("sum_kahan");
            return name;
        }
        /// INTERNAL ONLY
        ///
    ...
    {
        static const std::string& name() {
            static std::string name("sum_of_weights_kahan");
            return name;
        }
    ...
    {
        static const std::string& name() {
            static std::string name("sum_of_variates_kahan");
            return name;
        }
        /// INTERNAL ONLY
        ///
