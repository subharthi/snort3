...
namespace impl
{
    ...
    */
      ...
      : accumulator_base
    {
        ...
        void operator+=(p_square_cumulative_distribution_impl const &other)
        {
            // TODO do this
        }
        ...
        void serialize(Archive & ar, const unsigned int version) {
            ...
            ar & BOOST_SERIALIZATION_NVP(heights);
            ar & BOOST_SERIALIZATION_NVP(actual_positions);
            ar & BOOST_SERIALIZATION_NVP(desired_positions);
            ar & BOOST_SERIALIZATION_NVP(positions_increments);
            ar & BOOST_SERIALIZATION_NVP(histogram);
            ar & BOOST_SERIALIZATION_NVP(is_dirty);
        }
...
namespace tag
{
      ...
      , p_square_cumulative_distribution_num_cells
    {
        static const std::string& name() {
            static std::string name("p_square_cumulative_distribution");
            return name;
        }
        /// INTERNAL ONLY
        ///
