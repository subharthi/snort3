...
#include "statistics/parameters/quantile_probability.hpp"
#include "statistics/extended_p_square.hpp"
#include "statistics/weighted_extended_p_square.hpp"
#include "statistics/times2_iterator.hpp"
...
namespace impl
{
    ...
    */
        ...
        mergable_base
    {
        ...
        void operator+=(extended_p_square_impl const &other)
        {
            // TODO do this
        }
...
namespace tag
{
      ...
      : depends_on<extended_p_square>
    {
        static const std::string& name() {
            static std::string name("extended_p_square_quantile");
            return name;
        }
    ...
    {
        static const std::string& name() {
            static std::string name("extended_p_square_quantile_quadratic");
            return name;
        }
    ...
    {
        static const std::string& name() {
            static std::string name("weighted_extended_p_square_quantile");
            return name;
        }
    ...
    {
        static const std::string& name() {
            static std::string name("weighted_extended_p_square_quantile_quadratic");
            return name;
        }
